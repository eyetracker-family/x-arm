...
def conver_to_rotationMatrix(pose_mat):
    return [pose_mat[0][0],pose_mat[0][1],pose_mat[0][2],pose_mat[0][3],pose_mat[1][0],pose_mat[1][1],pose_mat[1][2],pose_mat[1][3],pose_mat[2][0],pose_mat[2][1],pose_mat[2][2],pose_mat[2][3],0,0,0,1]
...
class vr_tracked_device():
    ...
    def get_pose_rotationMatrix(self):
        ...
        return conver_to_rotationMatrix(pose[self.index].mDeviceToAbsoluteTracking)    
